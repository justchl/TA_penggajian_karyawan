...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Form Tunjangan</h1>
        ...
        <div class="col-lg-5 col-md-6 col-xs-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Tunjangan</h6>
                </div>

                <form action="{{ url('tunjangan/update/'.$row->id_tunjangan) }}" method="post" autocomplete="off">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control {{ $errors->has('nilai_tunjangan') ? 'is-invalid' : '' }}" name="nilai_tunjangan" value="{{ $row->nilai_tunjangan }}">
