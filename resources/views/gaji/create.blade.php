                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control {{ $errors->has('tgl') ? 'is-invalid' : '' }}" id="datepickerGaji" name="tgl" readonly>
                    ...
                    <div class="form-group">
                        <fieldset class="tunjangan-fieldset">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control gaji {{ $errors->has('tunjangan_pendidikan') ? 'is-invalid' : '' }}" id="t_pendidikan" name="tunjangan_pendidikan" onkeypress="return /[0-9]/i.test(event.key)" onkeyup="calculateGaji()" value="0">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control gaji {{ $errors->has('tunjangan_jabatan') ? 'is-invalid' : '' }}" id="t_jabatan" name="tunjangan_jabatan" onkeypress="return /[0-9]/i.test(event.key)" onkeyup="calculateGaji()" value="0">
                    ...
                    <div class="form-group">
                        <label>Total</label>
                        <input type="text" class="form-control" id="total" name="total" value="0" style="height: 60px; font-size:2rem;" readonly>
                    </div>
